...
import { GetFaqCategories, GetFaqQuestions } from "@/types/api-params/aboutus.params";

export const onGetFaqCategories : GetFaqCategories = async (
    params
) => {
...
export const onGetFaqQuestions :  GetFaqQuestions = async (
    params
) => {
