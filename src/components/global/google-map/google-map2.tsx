...
interface GoogleMapProps {
  ...
  maxMarkersToShow?: number; // Limit markers for performance
}
...
const GoogleMap2: React.FC<GoogleMapProps> = ({
  markers = [],
  center,
  zoom = 12,
  height = "500px",
  ...
  maxMarkersToShow = 500, // Default limit
}) => {
  ...
  useEffect(() => {
    ...
    // Use clustering if enabled and we have many markers
    if (enableClustering && googleMarkers.length > 10) {
      try {
  ...
  return (
    <div className="relative">
      {/* {markers.length > maxMarkersToShow && (
