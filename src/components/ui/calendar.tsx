    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          // "hover:[&>button]:bg-primary-10 hover:[&>button[data-selected=true]]:bg-primary"
        ),
        range_start: cn(
          "bg-primary-10 rounded-l-md dark:bg-slate-800",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn(
          "bg-primary-10 rounded-r-md dark:bg-slate-800",
          defaultClassNames.range_end
        ),
        today: cn(
          "bg-primary-10 text-slate-900 rounded-md data-[selected=true]:rounded-none dark:bg-slate-800 dark:text-slate-50",
